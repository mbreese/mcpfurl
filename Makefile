...
bin/mcpfurl.linux_musl_aarch64: go.mod go.sum $(SOURCES)
	CC=aarch64-linux-musl-gcc \
	CGO_ENABLED=1 GOOS=linux GOARCH=arm64 go build -ldflags='-extldflags "-static"' -o bin/mcpfurl.linux_musl_aarch64 main.go
